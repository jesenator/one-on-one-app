      ...
      <header className="border-b border-stone-200/80 bg-white/80 backdrop-blur-md sticky top-0 z-40">
        <div className="mx-auto max-w-5xl px-6 py-3">
          <div className="flex items-center justify-between">
            <Link href="/schedule" className="flex items-center gap-2.5 group">
              ...
              <div>
                <div className="text-sm font-semibold text-stone-900 group-hover:text-accent-500 transition">1:1 Scheduler</div>
                <div className="text-[11px] text-stone-400 leading-none">{retreat?.name}</div>
              </div>
            </Link>
